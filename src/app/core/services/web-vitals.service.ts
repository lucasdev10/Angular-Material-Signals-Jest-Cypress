...
export class WebVitalsService {
      ...
      const observer = new PerformanceObserver((list) => {
        for (const entry of list.getEntries()) {
          if (entry.name === 'first-contentful-paint') {
            ...
            console.log(
              ...oo_oo(`2646604850_62_12_62_65_4`, `✅ FCP: ${entry.startTime.toFixed(2)}ms`),
            );
          }
        }
      });
  ...
  private observeLCP(): void {
    try {
      const observer = new PerformanceObserver((list) => {
        ...
        if (this.metrics.LCP) {
          console.log(
            ...oo_oo(`2646604850_85_10_85_64_4`, `✅ LCP: ${this.metrics.LCP.toFixed(2)}ms`),
          );
        }
      });
    ...
    try {
      const observer = new PerformanceObserver((list) => {
        for (const entry of list.getEntries()) {
          ...
          if (this.metrics.FID) {
            console.log(
              ...oo_oo(`2646604850_106_12_106_66_4`, `✅ FID: ${this.metrics.FID.toFixed(2)}ms`),
            );
          }
        }
      });
      ...
      const observer = new PerformanceObserver((list) => {
        for (const entry of list.getEntries()) {
          ...
          if (!layoutShift.hadRecentInput) {
            ...
            console.log(...oo_oo(`2646604850_131_12_131_56_4`, `✅ CLS: ${clsValue.toFixed(4)}`));
          }
        }
      });
    ...
    try {
      ...
      if (navigationEntry) {
        ...
        if (this.metrics.TTFB) {
          console.log(
            ...oo_oo(`2646604850_152_10_152_66_4`, `✅ TTFB: ${this.metrics.TTFB.toFixed(2)}ms`),
          );
        }
      }
    } catch {
  ...
  private checkThresholds(): void {
    ...
    Object.entries(this.metrics).forEach(([metric, value]) => {
      ...
      console.log(
        ...oo_oo(`2646604850_206_6_206_63_4`, `${metric}: ${value.toFixed(2)} - ${status}`),
      );
    });
